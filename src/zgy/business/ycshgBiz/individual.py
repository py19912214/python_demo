...
class IndividualService(PigYcshgAi):
    def checkPasswordBeforeRegister(self):
        ...
        response = self.post('/ycshg-ai-platform-produce-ycshg-biz/yk/individual-tax/check-password-before-register',
                             data)
        print(response.text)
    ...
    def register(self):
        ...
        response = self.post('/ycshg-ai-platform-produce-ycshg-biz/yk/individual-tax/register',
                             data)
        print(response.text)
    ...
    def updateRegisterInfo(self):
        ...
        response = self.post('/ycshg-ai-platform-produce-ycshg-biz/yk/individual-tax/update-register-info',
                             data)
        print(response.text)
