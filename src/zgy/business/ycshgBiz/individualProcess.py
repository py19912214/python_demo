...
class IndividualProcessService(PigYcshgAi):
    def page(self):
        data = pageParam
        response = self.post('/ycshg-ai-platform-produce-ycshg-biz/yk/individual-tax-declare-process/select-info-page',
                             data)
        print(response.text)
    ...
    def declareConfirm(self):
        ...
        response = self.post('/ycshg-ai-platform-produce-ycshg-biz/yk/individual-tax-declare-process/declare-confirm',
                             data)
        print(response.text)

    def export(self, filePath):
        data = pageParam
        response = self.post('/ycshg-ai-platform-produce-ycshg-biz/yk/individual-tax-declare-process/export',
                             data)
